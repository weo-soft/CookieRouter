...
menu.add(new Upgrade('Decillion fingers', { 'Cursor': 500 }, 10 * octillion, { 'Cursor': fingersBoost(60.8 * billion), 'mouse': fingersBoost(60.8 * billion) }));
menu.add(new Upgrade('Undecillion fingers', { 'Cursor': 550 }, 10 * nonillion, { 'Cursor': fingersBoost(1.216 * trillion), 'mouse': fingersBoost(1.216 * trillion) }));
...
menu.add(new Upgrade('Mythril mouse', {}, 50 * octillion, { 'mouse': mouseBoost }));
menu.add(new Upgrade('Plasticene mouse', {}, 5 * nonillion, { 'mouse': mouseBoost }));
...
menu.add(new Upgrade('Generation degeneration', { 'Grandma': 450 }, 5 * nonillion, { 'Grandma': double }));
menu.add(new Upgrade('Visits', { 'Grandma': 500 }, 50 * decillion, { 'Grandma': double }));
menu.add(new Upgrade('Kitchen cabinets', { 'Grandma': 550 }, 500 * undecillion, { 'Grandma': double }));
menu.add(new Upgrade('Foam-tipped canes ', { 'Grandma': 600 }, 5 * tredecillion, { 'Grandma': double }));
...
menu.add(new Upgrade('Clone grandmas', { 'Grandma': 1, 'You': 15 }, 27 * octillion, { 'Grandma': double, 'You': grandmaBoost(18) }));
...
menu.add(new Upgrade('Global seed vault', { 'Farm': 400 }, 5.5 * octillion, { 'Farm': double }));
menu.add(new Upgrade('Reverse-veganism', { 'Farm': 450 }, 55 * nonillion, { 'Farm': double }));
menu.add(new Upgrade('Cookie mulch', { 'Farm': 500 }, 550 * undecillion, { 'Farm': double }));
menu.add(new Upgrade('Self-driving tractors', { 'Farm': 550 }, 5.5 * duodecillion, { 'Farm': double }));
menu.add(new Upgrade('Cookie constellations', { 'Farm': 600 }, 55 * tredecillion, { 'Farm': double }));
...
menu.add(new Upgrade('Bore again', { 'Mine': 400 }, 60 * octillion, { 'Mine': double }));
menu.add(new Upgrade('Air mining', { 'Mine': 450 }, 600 * nonillion, { 'Mine': double }));
menu.add(new Upgrade('Caramel alloys', { 'Mine': 500 }, 6 * undecillion, { 'Mine': double }));
menu.add(new Upgrade('Delicious mineralogy', { 'Mine': 550 }, 60 * duodecillion, { 'Mine': double }));
menu.add(new Upgrade('Mineshaft supports', { 'Mine': 600 }, 600 * tredecillion, { 'Mine': double }));
...
menu.add(new Upgrade('"Volunteer" interns', { 'Factory': 400 }, 650 * octillion, { 'Factory': double }));
menu.add(new Upgrade('Behavioral reframing', { 'Factory': 450 }, 6.5 * decillion, { 'Factory': double }));
menu.add(new Upgrade('The infinity engine', { 'Factory': 500 }, 65 * undecillion, { 'Factory': double }));
menu.add(new Upgrade('N-dimensional assembly lines', { 'Factory': 550 }, 650 * duodecillion, { 'Factory': double }));
menu.add(new Upgrade('Universal automation', { 'Factory': 600 }, 6.5 * quattuordecillion, { 'Factory': double }));
...
menu.add(new Upgrade('Rules of acquisition', { 'Bank': 400 }, 7 * nonillion, { 'Bank': double }));
menu.add(new Upgrade('Altruistic loop', { 'Bank': 450 }, 70 * decillion, { 'Bank': double }));
menu.add(new Upgrade('Diminishing tax returns', { 'Bank': 500 }, 700 * undecillion, { 'Bank': double }));
menu.add(new Upgrade('Cookie Points', { 'Bank': 550 }, 7 * tredecillion, { 'Bank': double }));
menu.add(new Upgrade('The big shortcake', { 'Bank': 600 }, 70 * quattuordecillion, { 'Bank': double }));
...
menu.add(new Upgrade('Psalm-reading', { 'Temple': 350 }, 10 * octillion, { 'Temple': double }));
// New v2052 temple upgrades
menu.add(new Upgrade('War of the gods', { 'Temple': 400 }, 100 * nonillion, { 'Temple': double }));
menu.add(new Upgrade('A novel idea', { 'Temple': 450 }, 1 * undecillion, { 'Temple': double }));
menu.add(new Upgrade('Apparitions', { 'Temple': 500 }, 10 * duodecillion, { 'Temple': double }));
menu.add(new Upgrade('Negatheism', { 'Temple': 550 }, 100 * tredecillion, { 'Temple': double }));
menu.add(new Upgrade('Temple traps', { 'Temple': 600 }, 1 * quindecillion, { 'Temple': double }));
...
menu.add(new Upgrade('Immobile spellcasting', { 'Wizard tower': 350 }, 165 * octillion, { 'Wizard tower': double }));
// New v2052 wizard tower upgrades
menu.add(new Upgrade('Electricity', { 'Wizard tower': 400 }, 1.65 * decillion, { 'Wizard tower': double }));
menu.add(new Upgrade('Spelling bees', { 'Wizard tower': 450 }, 16.5 * undecillion, { 'Wizard tower': double }));
menu.add(new Upgrade('Wizard basements', { 'Wizard tower': 500 }, 165 * duodecillion, { 'Wizard tower': double }));
menu.add(new Upgrade('Magical realism', { 'Wizard tower': 550 }, 1.65 * quattuordecillion, { 'Wizard tower': double }));
menu.add(new Upgrade('Polymorphism', { 'Wizard tower': 600 }, 16.5 * quindecillion, { 'Wizard tower': double }));
...
menu.add(new Upgrade('Autopilot', { 'Shipment': 300 }, 2.55 * octillion, { 'Shipment': double }));
menu.add(new Upgrade('Restaurants at the end of the universe', { 'Shipment': 350 }, 2.55 * nonillion, { 'Shipment': double }));
// New v2052 shipment upgrades
menu.add(new Upgrade('Universal alphabet', { 'Shipment': 400 }, 25.5 * decillion, { 'Shipment': double }));
menu.add(new Upgrade('Toroid universe', { 'Shipment': 450 }, 255 * undecillion, { 'Shipment': double }));
menu.add(new Upgrade('Prime directive', { 'Shipment': 500 }, 2.55 * tredecillion, { 'Shipment': double }));
menu.add(new Upgrade('Cosmic foreground radiation', { 'Shipment': 550 }, 25.5 * quattuordecillion, { 'Shipment': double }));
menu.add(new Upgrade('At your doorstep in 30 minutes or your money back', { 'Shipment': 600 }, 255 * quindecillion, { 'Shipment': double }));
...
menu.add(new Upgrade('The advent of chemistry', { 'Alchemy lab': 300 }, 37.5 * octillion, { 'Alchemy lab': double }));
menu.add(new Upgrade('On second thought', { 'Alchemy lab': 350 }, 37.5 * nonillion, { 'Alchemy lab': double }));
// New v2052 alchemy lab upgrades
menu.add(new Upgrade('Public betterment', { 'Alchemy lab': 400 }, 375 * decillion, { 'Alchemy lab': double }));
menu.add(new Upgrade('Hermetic reconciliation', { 'Alchemy lab': 450 }, 3.75 * duodecillion, { 'Alchemy lab': double }));
menu.add(new Upgrade('Chromatic cycling', { 'Alchemy lab': 500 }, 37.5 * tredecillion, { 'Alchemy lab': double }));
menu.add(new Upgrade('Arcanized glassware', { 'Alchemy lab': 550 }, 375 * quattuordecillion, { 'Alchemy lab': double }));
menu.add(new Upgrade('The dose makes the poison', { 'Alchemy lab': 600 }, 3.75 * sexdecillion, { 'Alchemy lab': double }));
...
menu.add(new Upgrade('The real world', { 'Portal': 300 }, 500 * octillion, { 'Portal': double }));
menu.add(new Upgrade('Dimensional garbage gulper', { 'Portal': 350 }, 500 * nonillion, { 'Portal': double }));
// New v2052 portal upgrades
menu.add(new Upgrade('Embedded microportals', { 'Portal': 400 }, 5 * undecillion, { 'Portal': double }));
menu.add(new Upgrade('His advent', { 'Portal': 450 }, 50 * duodecillion, { 'Portal': double }));
menu.add(new Upgrade('Domestic rifts', { 'Portal': 500 }, 500 * tredecillion, { 'Portal': double }));
menu.add(new Upgrade('Portal guns', { 'Portal': 550 }, 5 * quindecillion, { 'Portal': double }));
menu.add(new Upgrade('A way home', { 'Portal': 600 }, 50 * sexdecillion, { 'Portal': double }));
...
menu.add(new Upgrade('Cookietopian moments of maybe', { 'Time machine': 250 }, 7 * octillion, { 'Time machine': double }));
menu.add(new Upgrade('Second seconds', { 'Time machine': 300 }, 7 * nonillion, { 'Time machine': double }));
menu.add(new Upgrade('Additional clock hands', { 'Time machine': 350 }, 7 * decillion, { 'Time machine': double }));
// New v2052 time machine upgrades
menu.add(new Upgrade('Nostalgia', { 'Time machine': 400 }, 70 * undecillion, { 'Time machine': double }));
menu.add(new Upgrade('Split seconds', { 'Time machine': 450 }, 700 * duodecillion, { 'Time machine': double }));
menu.add(new Upgrade('Patience abolished', { 'Time machine': 500 }, 7 * quattuordecillion, { 'Time machine': double }));
menu.add(new Upgrade('Timeproof upholstery', { 'Time machine': 550 }, 70 * quindecillion, { 'Time machine': double }));
menu.add(new Upgrade('Rectifying a mistake', { 'Time machine': 600 }, 700 * sexdecillion, { 'Time machine': double }));
...
menu.add(new Upgrade('Some other super-tiny fundamental particle? Probably?', { 'Antimatter condenser': 250 }, 85 * octillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Quantum comb', { 'Antimatter condenser': 300 }, 85 * nonillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Baking Nobel prize', { 'Antimatter condenser': 350 }, 85 * decillion, { 'Antimatter condenser': double }));
// New v2052 antimatter condenser upgrades
menu.add(new Upgrade('The definite molecule', { 'Antimatter condenser': 400 }, 850 * undecillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Flavor itself', { 'Antimatter condenser': 450 }, 8.5 * tredecillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Delicious pull', { 'Antimatter condenser': 500 }, 85 * quattuordecillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Employee minification', { 'Antimatter condenser': 550 }, 850 * quindecillion, { 'Antimatter condenser': double }));
menu.add(new Upgrade('Candied atoms', { 'Antimatter condenser': 600 }, 8.5 * septendecillion, { 'Antimatter condenser': double }));
...
menu.add(new Upgrade('Lux sanctorum', { 'Prism': 200 }, 1.05 * octillion, { 'Prism': double }));
menu.add(new Upgrade('Reverse shadows', { 'Prism': 250 }, 1.05 * nonillion, { 'Prism': double }));
menu.add(new Upgrade('Crystal mirrors', { 'Prism': 300 }, 1.05 * decillion, { 'Prism': double }));
menu.add(new Upgrade('Reverse theory of light', { 'Prism': 350 }, 1.05 * undecillion, { 'Prism': double }));
menu.add(new Upgrade('Light capture measures', { 'Prism': 400 }, 10.5 * duodecillion, { 'Prism': double }));
// New v2052 prism upgrades
menu.add(new Upgrade('Light speed limit', { 'Prism': 450 }, 105 * tredecillion, { 'Prism': double }));
menu.add(new Upgrade('Occam\'s laser', { 'Prism': 500 }, 1.05 * quindecillion, { 'Prism': double }));
menu.add(new Upgrade('Hyperblack paint', { 'Prism': 550 }, 10.5 * sexdecillion, { 'Prism': double }));
menu.add(new Upgrade('Lab goggles but like cool shades', { 'Prism': 600 }, 105 * septendecillion, { 'Prism': double }));
...
menu.add(new Upgrade('Improbability drive', { 'Chancemaker': 200 }, 13 * octillion, { 'Chancemaker': double }));
menu.add(new Upgrade('Antisuperstistronics', { 'Chancemaker': 250 }, 13 * nonillion, { 'Chancemaker': double }));
menu.add(new Upgrade('Bunnypedes', { 'Chancemaker': 300 }, 13 * decillion, { 'Chancemaker': double }));
menu.add(new Upgrade('Revised probabilistics', { 'Chancemaker': 350 }, 13 * undecillion, { 'Chancemaker': double }));
menu.add(new Upgrade('0-sided dice', { 'Chancemaker': 400 }, 130 * duodecillion, { 'Chancemaker': double }));
// New v2052 chancemaker upgrades
menu.add(new Upgrade('A touch of determinism', { 'Chancemaker': 450 }, 1.3 * quattuordecillion, { 'Chancemaker': double }));
menu.add(new Upgrade('On a streak', { 'Chancemaker': 500 }, 13 * quindecillion, { 'Chancemaker': double }));
menu.add(new Upgrade('Silver lining maximization', { 'Chancemaker': 550 }, 130 * sexdecillion, { 'Chancemaker': double }));
menu.add(new Upgrade('Gambler\'s fallacy fallacy', { 'Chancemaker': 600 }, 1.3 * octodecillion, { 'Chancemaker': double }));
...
menu.add(new Upgrade('Chocolate ouroboros', { 'Fractal engine': 200 }, 155 * octillion, { 'Fractal engine': double }));
menu.add(new Upgrade('Nested', { 'Fractal engine': 250 }, 155 * nonillion, { 'Fractal engine': double }));
menu.add(new Upgrade('Space-filling fibers', { 'Fractal engine': 300 }, 155 * decillion, { 'Fractal engine': double }));
menu.add(new Upgrade('Endless book of prose', { 'Fractal engine': 350 }, 155 * undecillion, { 'Fractal engine': double }));
menu.add(new Upgrade('The set of all sets', { 'Fractal engine': 400 }, 1.55 * tredecillion, { 'Fractal engine': double }));
// New v2052 fractal engine upgrades
menu.add(new Upgrade('This upgrade', { 'Fractal engine': 450 }, 15 * quattuordecillion, { 'Fractal engine': double }));
menu.add(new Upgrade('A box', { 'Fractal engine': 500 }, 155 * quindecillion, { 'Fractal engine': double }));
menu.add(new Upgrade('Multiscale profiling', { 'Fractal engine': 550 }, 1.55 * septendecillion, { 'Fractal engine': double }));
menu.add(new Upgrade('The more they stay the same', { 'Fractal engine': 600 }, 15.5 * octodecillion, { 'Fractal engine': double }));
...
menu.add(new Upgrade('A nice cup of coffee', { 'Javascript console': 150 }, 35.5 * octillion, { 'Javascript console': double }));
menu.add(new Upgrade('Just-in-time baking', { 'Javascript console': 200 }, 35.5 * nonillion, { 'Javascript console': double }));
menu.add(new Upgrade('cookies++', { 'Javascript console': 250 }, 35.5 * decillion, { 'Javascript console': double }));
menu.add(new Upgrade('Software updates', { 'Javascript console': 300 }, 35.5 * undecillion, { 'Javascript console': double }));
menu.add(new Upgrade('Game.Loop', { 'Javascript console': 350 }, 35.5 * duodecillion, { 'Javascript console': double }));
menu.add(new Upgrade('eval()', { 'Javascript console': 400 }, 355 * tredecillion, { 'Javascript console': double }));
// New v2052 javascript console upgrades
menu.add(new Upgrade('Your biggest fans', { 'Javascript console': 450 }, 3.55 * quindecillion, { 'Javascript console': double }));
menu.add(new Upgrade('Hacker shades', { 'Javascript console': 500 }, 35.5 * sexdecillion, { 'Javascript console': double }));
menu.add(new Upgrade('PHP containment vats', { 'Javascript console': 550 }, 355 * septendecillion, { 'Javascript console': double }));
menu.add(new Upgrade('Simulation failsafes', { 'Javascript console': 600 }, 3.55 * novemdecillion, { 'Javascript console': double }));
...
menu.add(new Upgrade('Escape plan', { 'Idleverse': 100 }, 60 * octillion, { 'Idleverse': double }));
menu.add(new Upgrade('Game design', { 'Idleverse': 150 }, 6 * nonillion, { 'Idleverse': double }));
menu.add(new Upgrade('Sandbox universes', { 'Idleverse': 200 }, 6 * decillion, { 'Idleverse': double }));
menu.add(new Upgrade('Multiverse wars', { 'Idleverse': 250 }, 6 * undecillion, { 'Idleverse': double }));
menu.add(new Upgrade('Mobile ports', { 'Idleverse': 300 }, 6 * duodecillion, { 'Idleverse': double }));
menu.add(new Upgrade('Encapsulated realities', { 'Idleverse': 350 }, 6 * tredecillion, { 'Idleverse': double }));
menu.add(new Upgrade('Extrinsic clicking', { 'Idleverse': 400 }, 60 * quattuordecillion, { 'Idleverse': double }));
// New v2052 idleverse upgrades
menu.add(new Upgrade('Universal idling', { 'Idleverse': 450 }, 600 * quindecillion, { 'Idleverse': double }));
menu.add(new Upgrade('Break the fifth wall', { 'Idleverse': 500 }, 6 * septendecillion, { 'Idleverse': double }));
menu.add(new Upgrade('Opposite universe', { 'Idleverse': 550 }, 60 * octodecillion, { 'Idleverse': double }));
menu.add(new Upgrade('The other routes to Rome', { 'Idleverse': 600 }, 600 * novemdecillion, { 'Idleverse': double }));
...
menu.add(new Upgrade('Front and back hemispheres', { 'Cortex baker': 50 }, 95 * octillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Neural networking', { 'Cortex baker': 100 }, 9.5 * nonillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Cosmic brainstorms', { 'Cortex baker': 150 }, 950 * nonillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Megatherapy', { 'Cortex baker': 200 }, 950 * decillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Synaptic lubricant', { 'Cortex baker': 250 }, 950 * undecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Psychokinesis', { 'Cortex baker': 300 }, 950 * duodecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Spines', { 'Cortex baker': 350 }, 950 * tredecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Neuraforming', { 'Cortex baker': 400 }, 9.5 * quindecillion, { 'Cortex baker': double }));
// New v2052 cortex baker upgrades
menu.add(new Upgrade('Epistemological trickery', { 'Cortex baker': 450 }, 95 * sexdecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Every possible idea', { 'Cortex baker': 500 }, 950 * septendecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('The land of dreams', { 'Cortex baker': 550 }, 9.5 * novemdecillion, { 'Cortex baker': double }));
menu.add(new Upgrade('Intellectual property theft', { 'Cortex baker': 600 }, 95 * vigintillion, { 'Cortex baker': double }));

// You upgrades (all 15 tiered upgrades from v2052)
menu.add(new Upgrade('Cloning vats', { 'You': 1 }, 5.4 * octillion, { 'You': double }));
menu.add(new Upgrade('Energized nutrients', { 'You': 5 }, 27 * octillion, { 'You': double }));
menu.add(new Upgrade('Stunt doubles', { 'You': 25 }, 270 * octillion, { 'You': double }));
menu.add(new Upgrade('Clone recycling plant', { 'You': 50 }, 27 * nonillion, { 'You': double }));
menu.add(new Upgrade('Free-range clones', { 'You': 100 }, 2.7 * decillion, { 'You': double }));
menu.add(new Upgrade('Genetic tailoring', { 'You': 150 }, 270 * decillion, { 'You': double }));
menu.add(new Upgrade('Power in diversity', { 'You': 200 }, 270 * undecillion, { 'You': double }));
menu.add(new Upgrade('Self-betterment', { 'You': 250 }, 270 * duodecillion, { 'You': double }));
menu.add(new Upgrade('Source control', { 'You': 300 }, 270 * tredecillion, { 'You': double }));
menu.add(new Upgrade('United workforce', { 'You': 350 }, 270 * quattuordecillion, { 'You': double }));
menu.add(new Upgrade('Safety patrols', { 'You': 400 }, 2.7 * sexdecillion, { 'You': double }));
menu.add(new Upgrade('Clone rights', { 'You': 450 }, 27 * septendecillion, { 'You': double }));
menu.add(new Upgrade('One big family', { 'You': 500 }, 270 * octodecillion, { 'You': double }));
menu.add(new Upgrade('Fine-tuned body plans', { 'You': 550 }, 2.7 * vigintillion, { 'You': double }));
menu.add(new Upgrade('Reading your clones bedtime stories', { 'You': 600 }, 27 * unvigintillion, { 'You': double }));
