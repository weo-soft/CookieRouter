/**
 * Cookie Clicker version v10466_xmas (Christmas/Holiday mode) data
 * Ported from Python v10466_xmas.py
 */
...
function mult(x) {
  return new Effect(2, (r, game) => r * x);
}
...
// Christmas Upgrades
menu.add(new Upgrade('Santas legacy', {}, 2525, { 'all': mult(1.4) }));
menu.add(new Upgrade('Increased merriness', {}, 2525, { 'all': mult(1.15) }));
menu.add(new Upgrade('Improved jolliness', {}, 2525, { 'all': mult(1.15) }));
menu.add(new Upgrade('Reindeer baking grounds', {}, 2525, { 'all': mult(1.05) }));
menu.add(new Upgrade('Ho ho ho-flavored frosting', {}, 2525, { 'all': mult(1.05) }));
menu.add(new Upgrade('Toy workshop', {}, 2525, { 'all': mult(1/0.975) }));
menu.add(new Upgrade('Season savings', {}, 2525, { 'all': mult(1/0.995) }));
menu.add(new Upgrade('Lump of coal', {}, 2525, { 'all': mult(1.01) }));
menu.add(new Upgrade('An itchy sweater', {}, 2525, { 'all': mult(1.01) }));
menu.add(new Upgrade('Santas helpers', {}, 2525, { 'mouse': mult(1.1) }));
menu.add(new Upgrade('Naughty list', {}, 2525, { 'Grandma': double }));
menu.add(new Upgrade('<Festive tree>', {}, 256, { 'all': mult(1.5 / 1.4) }));
menu.add(new Upgrade('<Festive present>', {}, 3125, { 'all': mult(1.6 / 1.5) }));
menu.add(new Upgrade('<Festive elf fetus>', {}, 46656, { 'all': mult(1.7 / 1.6) }));
menu.add(new Upgrade('Elf toddler', {}, 823543, { 'all': mult(1.8 / 1.7) }));
